...
import Axios, { AxiosInstance, AxiosTransformer,AxiosRequestConfig } from "axios";
...
const defaultConfig: AxiosRequestConfig = {
  baseURL: process.env.NODE_ENV === "production" ? import.meta.env.VITE_PROXY_DOMAIN_REAL+'api/v1' :  import.meta.env.VITE_PROXY_DOMAIN + '',
...
console.log('baseurl:', import.meta.env.VITE_PROXY_DOMAIN);
